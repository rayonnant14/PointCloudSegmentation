...
from model.tasks.semantic.postproc.CRF import CRF
...
class Segmentator(nn.Module):
    def __init__(self,
        ...
        bboneModule = imp.load_source(
            "bboneModule",
            '/home/jovyan/work/model/backbones/' +
...
>>>>>>> upstream/master
    ...
    def save_checkpoint(self, logdir, suffix=""):
        ...
        torch.save(self.head.state_dict(),
                   logdir + "/segmentation_head" + suffix)
        if self.CRF:
            torch.save(self.CRF.state_dict(),
                       logdir + "/segmentation_CRF" + suffix)
